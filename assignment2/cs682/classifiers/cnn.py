...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out_softmax, cache_softmax = affine_forward(out_relu, W3, b3)
        scores = out_softmax
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dX3, dW3, db3 = affine_backward(dscores, cache_softmax)
        dX2, dW2, db2 = affine_relu_backward(dX3, cache_relu)
